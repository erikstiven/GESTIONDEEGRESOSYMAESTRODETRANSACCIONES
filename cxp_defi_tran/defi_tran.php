...
<? if ($ejecuta) { ?>
    ...
    <script>
		...
		function seleccionaItem(tran_cod_tran, trans_tip_tran, tran_des_tran, tran_ant_tran, trans_tip_comp, tran_cod_tret, tran_cod_cuen){
			//alert(tran_ant_tran);
        ...
        <form id="form1" name="form1" action="javascript:void(null);">
			<div class="col-md-4"> 
				<table id="example" class="table table-striped table-bordered table-hover table-condensed"  style="width: 100%;" align="center">
						<thead>
							<tr>
								<td colspan="5" class="bg-primary">LISTA DE TRANSACCIONES CUENTAS POR PAGAR</td>
							</tr>
							<tr class="info">
								<td>Codigo</td>	
								<td>Tipo</td>
